import 'package:creo_login/categories.dart';
import 'package:creo_login/categorylist.dart';

import 'package:creo_login/newscategories.dart';
...
class HamiltonPage extends StatefulWidget {
  ...
  @override
  State<HamiltonPage> createState() => _HamiltonPageState();
}

class _HamiltonPageState extends State<HamiltonPage> {
  @override
